...
const HelpSupport = () => {
  ...
  const faqs = [
    ...
    { q: 'How does PAGYSS write my thesis?', a: 'PAGYSS helps you write academic content based on your topic, field, and methodology. You can guide the process by uploading reference structures or pasting sample work.' },
    { q: 'Are the references real?', a: 'Yes! PAGYSS fetches real academic references from Crossref, a database of over 150 million scholarly articles. References include real authors, titles, journals, and DOIs.' },
    ...
    <div style={{ minHeight: '100vh', backgroundColor: colors.background }}>
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: isMobile ? '24px 16px' : '48px 32px' }}>
        <div style={{ backgroundColor: colors.surface, borderRadius: isMobile ? '12px' : '16px', padding: isMobile ? '24px' : '40px', border: `1px solid ${colors.border}`, marginBottom: '32px' }}>
          ...
          <p style={{ color: colors.textSecondary, marginBottom: isMobile ? '24px' : '32px', fontSize: isMobile ? '14px' : '15px' }}>Find answers to common questions about PAGYSS.</p>
