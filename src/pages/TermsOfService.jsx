      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: isMobile ? '24px 16px' : '48px 32px' }}>
        ...
        <div style={{ backgroundColor: colors.surface, borderRadius: isMobile ? '12px' : '16px', padding: isMobile ? '24px' : '40px', border: `1px solid ${colors.border}` }}>
          ...
          <p style={{ color: colors.text, lineHeight: '1.8', marginBottom: '24px' }}>
            Welcome to PAGYSS, operated by A&P Firms. By accessing or using our thesis generation platform, you agree to these Terms of Service. Please read them carefully.
          </p>

          <Section title="1. Acceptance of Terms" colors={colors}>
            <p>By creating an account or using PAGYSS, you acknowledge that you have read, understood, and agree to be bound by these Terms. If you do not agree, you may not use the Service.</p>
          </Section>
          ...
          <Section title="4. AI-Generated Content Disclaimer" colors={colors}>
            <div style={{ backgroundColor: isDarkMode ? '#2d2d2d' : '#fef3c7', border: `1px solid ${isDarkMode ? '#d97706' : '#fbbf24'}`, borderRadius: '8px', padding: '20px', marginBottom: '20px' }}>
              ...
              <p>PAGYSS uses artificial intelligence to generate academic content. While we strive for accuracy:</p>
            </div>
            ...
            <ListItem>PAGYSS does not guarantee academic validity or originality</ListItem>
            <ListItem>Citations must be independently verified</ListItem>
          </Section>

          <Section title="5. Acceptable Use" colors={colors}>
            <ListItem>Do NOT use PAGYSS for academic fraud or plagiarism</ListItem>
          ...
          <Section title="6. Intellectual Property" colors={colors}>
            ...
            <p><strong>Our Content:</strong> PAGYSS platform, code, design, and proprietary algorithms belong to A&P Firms.</p>
          </Section>
          ...
          <Section title="7. Academic Integrity" colors={colors}>
            ...
            <ListItem>PAGYSS is not liable for academic penalties from improper use</ListItem>
          </Section>
          ...
          <Section title="10. Limitation of Liability" colors={colors}>
            <ListItem>PAGYSS is provided "AS IS" without warranties</ListItem>
