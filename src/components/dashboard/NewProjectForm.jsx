      ...
      <form onSubmit={onSubmit}>
        <div style={{ display: 'grid', gap: '20px' }}>
          <div>
            ...
            <input type="text" name="title" value={form.title} onChange={onChange} required style={inputStyle} placeholder="e.g., Impact of AI on Healthcare" />
          </div>
          <div>
            <label style={labelStyle}>Level of Study *</label>
            <select name="level" value={form.level} onChange={onChange} required style={inputStyle}>
          ...
          <div>
            ...
            <select name="field" value={form.field} onChange={onChange} required style={inputStyle}>
          ...
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
              <label style={{ fontWeight: '500', color: colors.text }}>Research Topic/Question *</label>
            ...
            <textarea name="topic" value={form.topic} onChange={onChange} required rows="3" style={{
          ...
          <div>
            ...
            <select name="methodology" value={form.methodology} onChange={onChange} style={inputStyle}>
          ...
          <div>
            <label style={labelStyle}>Reference Style</label>
            <select name="referenceStyle" value={form.referenceStyle} onChange={onChange} style={inputStyle}>
